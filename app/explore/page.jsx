        ...
        <div className="flex flex-col gap-4 md:flex-row justify-between items-center my-4">
          <div className="grid grid-cols-2 items-center gap-7">
            {features.map((feature) => (
              ...
              <div className="w-full md:w-[420px] md:h-[300px] bg-[#F7F7F7] p-4 rounded-md">
                <p className="text-[#484848] text-[1rem]">
                ...
                <div className="flex gap-4">
                  <div className="flex items-center gap-2 bg-[#FF5A60] p-2 px-6 rounded-md mt-2">
                  ...
                  <div className="flex items-center gap-2 bg-blue-700 mt-2 p-2 px-4 rounded-md">
                    <p className="text-white text-[1rem]">
                      Booking
                      <span className="text-blue-400 text-[1rem]">.com</span>
                    </p>
                  </div>
                </div>
              </div>
